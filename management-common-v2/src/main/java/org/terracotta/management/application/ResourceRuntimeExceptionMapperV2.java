 ...
 */
@Provider
public class ResourceRuntimeExceptionMapperV2 implements ExceptionMapper<ResourceRuntimeException> {

  private static final Logger LOG = LoggerFactory.getLogger(ResourceRuntimeExceptionMapperV2.class);
